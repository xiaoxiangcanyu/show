...
public class SAXContentHandlerEnhanced extends SAXContentHandler {
	private DocumentFactoryWithLocator documentFactory = null;

	public SAXContentHandlerEnhanced(DocumentFactory documentFactory2, ElementHandler dispatchHandler) {
