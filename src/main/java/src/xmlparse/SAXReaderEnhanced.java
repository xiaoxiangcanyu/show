...
public class SAXReaderEnhanced extends SAXReader {
	DocumentFactory docFactory;
	Locator locator;

	public SAXReaderEnhanced(DocumentFactory docFactory) {
		// TODO Auto-generated constructor stub
		super(docFactory);
		this.docFactory = docFactory;
	}

	public SAXReaderEnhanced(DocumentFactory docFactory, Locator locator) {
		// TODO Auto-generated constructor stub
		super(docFactory);
	...
	protected SAXContentHandler createContentHandler(XMLReader reader) {
		return new SAXContentHandlerEnhanced(this.getDocumentFactory(), super.getDispatchHandler());
	}
	...
	public Document read(InputSource in) throws DocumentException {
		try {
			...
			((SAXContentHandlerEnhanced) contentHandler).setDocFactory((DocumentFactoryWithLocator) this.docFactory);
